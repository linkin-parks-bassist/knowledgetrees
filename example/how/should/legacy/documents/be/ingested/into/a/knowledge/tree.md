...
answer before shortening bootstrap text. Detection gates must stay self-contained
in bootstrap; detail can move to reachable leaves, but no rule may survive only in
