...
or test evidence currently proves. Preserve the current answer in its semantic owner;
retain historical detail only when it explains a live constraint or decision. Never
copy mutually inconsistent source passages into separate leaves without resolution.
